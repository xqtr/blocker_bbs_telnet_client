...
uses Classes, SysUtils, PasZLib, zbase,xcrt,xstrings;
...
function rawzipstream(infile, outfile: string): boolean;
function rawunzipStream(infile, outfile: string): boolean;
